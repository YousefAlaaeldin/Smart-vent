...
#define POT_PIN 26
#define MQ_PIN 27
int mqThreshold = 300;  // Adjust this value

#define ALERT_LED 13     // LED for gas alert
...
void loop() {
  ...
  float setTemp = map(potRaw, 0, 1023, 10, 40);
  ...
  int potPWM = map(abs(currentTemp-setTemp),0,20,80,255);
